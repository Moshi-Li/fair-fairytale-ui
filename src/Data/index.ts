import characterMeta from "./ali-baba-and-forty-thieves.character_attributes.json";
import storyMeta from "./ali-baba-and-forty-thieves.story_major_statistics.json";
import eventMeta from "./ali-baba-and-forty-thieves.events_major_statistics.json";
import eventMajorList from "./ali-baba-and-forty-thieves.major_characters_temporal_events.json";
...
const Data = {
  ...
  storyMeta,
  eventMeta,
  eventMajorList: processEventList(eventMajorList),
  paragraph,
};
